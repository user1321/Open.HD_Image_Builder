...
git clone https://github.com/user1321/raspi2png.git

log "Download v4l2loopback"
sudo git clone https://github.com/user1321/v4l2loopback.git
...
sudo git clone https://github.com/user1321/cmavnode.git
pushd cmavnode
sudo git submodule update --init
popd
